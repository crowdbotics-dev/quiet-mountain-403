"""
Django settings for quiet_mountain_403 project.
...
ROOT_URLCONF = 'quiet_mountain_403.urls'
...
WSGI_APPLICATION = 'quiet_mountain_403.wsgi.application'
...
SPECTACULAR_SETTINGS = {
    ...
    "TITLE": "quiet_mountain_403 API",
    "DESCRIPTION": "API documentation for quiet_mountain_403 App",
    "VERSION": "v1",
}
